#!/usr/bin/python3
# Demonstration of how to generate many config objects with list-comprehension expressions
...
class TestSaiDashVnetsListComprehension:
    @pytest.mark.ptf
    @pytest.mark.snappi
    def test_many_vnets_create_via_listcomprehension(self, dpu):
    ...
    @pytest.mark.ptf
    @pytest.mark.snappi
    def test_many_vnets_remove_via_listcomprehension(self, dpu):
