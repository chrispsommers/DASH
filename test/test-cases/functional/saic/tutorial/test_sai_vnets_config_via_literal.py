#!/usr/bin/python3
# Demonstration of how to generate many config objects with literal SAI config records
...
class TestSaiDashVnetsLiteral:
    @pytest.mark.ptf
    @pytest.mark.snappi
    def test_many_vnets_create_via_literal(self, dpu):
    ...
    @pytest.mark.ptf
    @pytest.mark.snappi
    def test_many_vnets_remove_via_literal(self, dpu):
